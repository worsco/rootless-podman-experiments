...
[worsco@rhel8-server-01-zcsi php-hello-ubi8]$ sudo firewall-cmd --add-port=8080/tcp
[worsco@rhel8-server-01-zcsi php-hello-ubi8]$ sudo firewall-cmd --permanent --add-port=8080/tcp
